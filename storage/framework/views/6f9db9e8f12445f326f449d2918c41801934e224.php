		...
		<ul class="nav" id="side-menu">
			...
			<li><a href="#"><i class="fa fa-table fa-fw"></i>Quản Lý<span
				...
				<ul class="nav nav-second-level">
					...
					<li><a href="<?php echo e(url('admin/the-loai')); ?>">QL Thể Loại truyện</a></li>
			...
			<li><a href="#"><i class="fa fa-table fa-fw"></i>Quản Lý Nhóm Dịch<span
				class="fa arrow"></span></a>
			<ul class="nav nav-second-level">
				<li><a href="<?php echo e(url('admin/nhom-dich')); ?>">Danh Sách Nhóm Dịch</a></li>
				<li><a href="<?php echo e(url('admin/nhom-dich/thanh-vien')); ?>">Danh Sách Thành Viên</a></li>
				<li><a href="<?php echo e(url('admin/nhom-dich/vai-tro')); ?>">Vai Trò Thành Viên</a></li>
