...
<a href="<?php echo e(url('/')); ?>" id="home">
        ...
        <div class="dropdown" id="danhMuc">
            ...
            <a href="<?php echo e(url('danhmuc')); ?>"><strong class="danhMucFull">Truyện full
        ...
        <div class="dropdown" id="theLoai">
            ...
            <div class="dropdown-content">
                <table width="100%" >
                    <tr>
                        <td  >
                            <a href="<?php echo e(url('theloai')); ?>"><strong>Tiên hiệp
    ...
    </div><?php /**PATH D:\HocTap\xampp\htdocs\NhomTruyenLaravel\resources\views/layout/header.blade.php ENDPATH**/ ?>