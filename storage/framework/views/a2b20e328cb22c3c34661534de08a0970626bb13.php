            ...
            <div class="panel-body">
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover" border="0">
                        <tbody>
                            <tr>
                            <form action="<?php echo e(url('admin/nhom-dich/search')); ?>" method="get">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <td scope="row"><?php echo e($loop->index+1); ?></td>
                                    ...
                                    <td><?php echo e($item->ten_nhom_dich); ?></td>
                                    <td>socwaemoiqn</td>
                                    ...
                                    <a data-toggle="modal" id="<?php echo e($item->id); ?>" data-target="#sua" class="btn btn-success btn-circle btn-sua" title="Chỉnh sửa nhóm dịch">
                                            <i class="fa  fa-edit"></i>
                                        </a>
                                        <a id="<?php echo e($item->id); ?>" class="btn btn-danger btn-circle btn-xoa" title="Xóa nhóm dịch">
            ...
            <div class="panel panel-green">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <form
                        action="<?php echo e(url('admin/nhom-dich/insert')); ?>"
                                method="post">
