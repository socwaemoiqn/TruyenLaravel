            ...
            <div class="panel-body">
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover" border="0">
                        <tbody>
                            <tr>
                            <form action="<?php echo e(url('admin/the-loai/search')); ?>" method="get">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <td scope="row"><?php echo e($loop->index+1); ?></td>
                                    ...
                                    <td><?php echo e($item->ten_the_loai); ?></td>
                                    ...
                                    <td class="center">
                                     <form id="form<?php echo e($item->id); ?>" action="<?php echo e(url('admin/the-loai/delete/'.$item->id)); ?>" method="post">
                                        <a class="btn btn-primary btn-circle" title="Tất cả truyện" >
                                            <i class="fa fa-list-ul"></i>
                                        </a> 
                                    <a data-toggle="modal" id="<?php echo e($item->id); ?>" data-target="#sua" class="btn btn-success btn-circle btn-sua" title="Chỉnh sửa thể loại">
                                            <i class="fa  fa-edit"></i>
                                        </a> <a id="<?php echo e($item->id); ?>" class="btn btn-danger btn-circle btn-xoa" title="Xóa thể loại" >
        ...
        <div class="col-lg-12">
            <div class="panel panel-green">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <form action="<?php echo e(url('admin/the-loai/insert')); ?>"method="post">
            ...
            <div class="panel panel-green">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <form
                                 action="<?php echo e(url('admin/the-loai/edit')); ?>"
                                method="post">
...
<?php echo $__env->make('layout.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\HocTap\xampp\htdocs\NhomTruyenLaravel\resources\views/admin/ql_the_loai.blade.php ENDPATH**/ ?>