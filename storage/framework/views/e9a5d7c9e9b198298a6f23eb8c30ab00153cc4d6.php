            ...
            <div class="col-3" id="truyen-vua-doc">
                        <div class="title">TRUYỆN VỪA ĐỌC <i class="fas fa-arrow-circle-down"></i></div>
                            <div class="content">
                                <table>
                                    <tr>
                                    <td><a href="<?php echo e(url('info')); ?>"><i class="fas fa-book-reader"></i> Tối cường thần thoại đế hoàng <br> (Chương 1998)</a></td>
                                    </tr>
                                    <tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\HocTap\xampp\htdocs\NhomTruyenLaravel\resources\views/index.blade.php ENDPATH**/ ?>